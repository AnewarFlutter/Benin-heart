...
La feature **User** centralise toute la logique métier et technique liée aux user(s) dans le projet.
...
* **User_README.md** → Documentation de la feature.
...
* **Découplage total** : Le User`Controller` ne dépend pas directement d’une techno (ex: Supabase). Il utilise uniquement les **usecases** définis au niveau du domaine.
